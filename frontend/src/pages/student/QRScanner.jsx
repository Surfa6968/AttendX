...
import { validateQR, scanQR } from "../../services/studentAttendanceService";
    ...
    scanner.render(
      async (decodedText) => {
        try {
          ...
          alert(
            error.response?.data?.message || error.message || "QR Scan Failed.",
          );
        }
      },
    ...
    <div className="container py-4">
      <div className="card shadow">
        <div className="card-header bg-success text-white">
          <h4 className="mb-0">Scan QR Attendance</h4>
        </div>
